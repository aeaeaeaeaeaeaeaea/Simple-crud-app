...
public class Robot {
    ...
    public Robot(int id, Buyer buyer, Task task, List<LogEntry> logEntryList, WinterTask winterTask, String owner, String robotName, long robotNumber, long pinCode, LocalDate robotDate) {
        this.id = id;
        this.buyer = buyer;
        this.task = task;
